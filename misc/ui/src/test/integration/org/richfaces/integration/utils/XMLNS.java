...
/**
 * Helper class for saving XMLNamespaces.
 *
...
public class XMLNS {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.URI, other.URI) && Objects.equal(this.name, other.name);
    }
    ...
    public static XMLNS jsfHtml() {
        //no namespace, because 'facelet-template.xhtml' has already added this namespace
        return new XMLNS("h", "");
    }
